    ...
    <>
      ...
      <section className="section-spacing-bottom">
        <div className="container-max">
          <div className="page-header -mb-[3px] pl-[calc(2rem+3.05%)]">
      ...
      <section className="pt-0 pb-[22px] sm:pt-[37px] sm:pb-16 lg:pt-[53px] lg:pb-20">
        <div className="container-max px-8">
          <h2 className="mb-8 text-[36px] text-left font-bold pl-[calc(2rem+3.05%)]">Food Destination</h2>
      ...
      <section className="pb-[22px] sm:pb-16 lg:pb-20">
        <div className="container-max px-8">
          <h2 className="mb-8 text-[36px] text-left font-bold pl-[calc(2rem+3.05%)]">Restaurants</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-0">
      ...
      <section className="pb-[22px] sm:pb-16 lg:pb-20">
        <div className="container-max px-8">
          <h2 className="mb-8 text-[36px] text-left font-bold pl-[calc(2rem+3.05%)]">Farmers Markets</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-0">
      ...
      <section className="pb-[22px] sm:pb-16 lg:pb-20">
        <div className="container-max px-8">
          <h2 className="mb-8 text-[36px] text-left font-bold pl-[calc(2rem+3.05%)]">Food Festivals</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-0">
