...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    if (existingScript) {
      ...
      if (window.turnstile && document.getElementById("cf-turnstile") && !turnstileWidgetId.current) {
        turnstileWidgetId.current = window.turnstile.render("#cf-turnstile", {
          ...
          theme: "light",
          size: "compact", // Compact size - minimal footprint
        });
      }
      return;
    }
    ...
    return () => {
      // Cleanup widget only, keep script loaded
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Here you would send the form data along with the turnstile token to your backend
      // The backend should verify the token with Cloudflare before processing the form
    ...
    <main>
      ...
      <section className="max-w-[616px] sm:max-w-[670px] mx-auto px-4 sm:px-6 md:px-8 mb-16 sm:mb-24">
        ...
        <div className="relative inline-block w-full">
          {/* The "Photo" - White Polaroid Border */}
          <div
            className="relative bg-white p-4 sm:p-6 shadow-2xl transform rotate-[-1deg]"
            style={{
          ...
          >
                ...
                <form onSubmit={handleSubmit} className="relative space-y-[23px] sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-[23px] sm:gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white/80 border-2 border-[#C9B8AE] focus:border-[#7A9B8E] focus:outline-none transition-colors disabled:opacity-50"
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      required
                      disabled={isSubmitting}
                      className="w-full px-4 py-[11px] sm:py-3 bg-white/80 border-2 border-[#C9B8AE] focus:border-[#7A9B8E] focus:outline-none transition-colors disabled:opacity-50"
                    >
                      ...
                      <option value="Recipe Development">Recipe Development</option>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={5}
                      disabled={isSubmitting}
                      className="w-full px-4 py-[11px] sm:py-3 bg-white/80 border-2 border-[#C9B8AE] focus:border-[#7A9B8E] focus:outline-none transition-colors resize-none disabled:opacity-50"
            ...
            {/* Handwritten-style caption at bottom (like Polaroids) */}
            <div className="absolute bottom-2 sm:bottom-4 left-0 right-0 text-center">
              ...
              >
                ...
                <Mail size={21} className="text-[#7A9B8E]" style={{ transform: "translateY(1px)" }} />
              </p>
            </div>
          </div>

          {/* Vintage photo aging effects - corner creases */}
          <div
