...
export default function SidesPage() {
  ...
  return (
    <ListingPageLayout
      title="Sides"
      description="Complete your meal with these delicious side dishes. From roasted vegetables to creamy salads, find the perfect accompaniment to any main course."
      breadcrumbItems={[
