...
export default function HolidayPage() {
  ...
  return (
    <ListingPageLayout
      title="Holiday"
      description="Celebrate special occasions with these festive recipes. From traditional favorites to creative new dishes perfect for making memories."
      breadcrumbItems={[
        { label: "Recipes", href: "/recipes" },
        { label: "Holiday" },
      ]}
      items={holidayRecipes}
