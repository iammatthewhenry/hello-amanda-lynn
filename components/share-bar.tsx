...
export function ShareBar({ title, description, imageUrl, showPrint = false }: ShareBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      >
        <svg className="w-[21px] h-[21px]" viewBox="0 0 24 24" fill="currentColor">
      ...
      >
        <Facebook className="w-[21px] h-[21px]" />
      </a>
      ...
      >
        <Twitter className="w-[21px] h-[21px]" />
      </a>
      ...
      >
        {copied ? <Copy className="w-[21px] h-[21px]" /> : <LinkIcon className="w-[21px] h-[21px]" />}
      </button>
