...
/*
 GLOBAL-ALIGNED RECIPE TEMPLATE
 - MUST NOT push breadcrumbs down
 - Uses same vertical start as section pages
 - No hidden margins
*/
...
export function RecipePageTemplate({ children }: RecipePageTemplateProps) {
  return (
    <div
      className="border border-border mt-12 sm:mt-16 lg:mt-20 pt-6 pb-8 px-[4vw] sm:pt-10 sm:pb-16 sm:px-8 lg:pt-[63px] lg:pb-24 lg:px-14 relative w-full"
      style={{
        ...
        boxShadow:
          "0 -12px 24px -6px rgba(0,0,0,0.21), 0 12px 24px -6px rgba(0,0,0,0.21), 0 8px 32px rgba(0,0,0,0.15), 0 16px 48px rgba(0,0,0,0.10)",
      }}
    >
      {children}
    </div>
